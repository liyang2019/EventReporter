...
public class EventReportActivity extends AppCompatActivity {
    ...
    private ImageView mImagineViewLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImagineViewLocation = (ImageView) findViewById(R.id.img_event_location);
        mImagineViewLocation.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void uploadImage(final String eventId) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast toast = Toast.makeText(getBaseContext(),
                        "The upload image is failed, please check you network status.", Toast.LENGTH_SHORT);
                toast.show();
            }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Log.i(TAG, "upload image successfully" + eventId);
                database.child("events").child(eventId).child("imgUri").
                        setValue(downloadUrl.toString(), new DatabaseReference.CompletionListener() {
                            ...
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                if (databaseError != null) {
                                    Toast toast = Toast.makeText(getBaseContext(),
                                            "The upload image url is failed, please check you network status.", Toast.LENGTH_SHORT);
                                    toast.show();
                                } else {
                                    Toast toast = Toast.makeText(getBaseContext(), "The upload image url is reported", Toast.LENGTH_SHORT);
                                    toast.show();
