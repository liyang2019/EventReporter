...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    private void configureCommentView(final CommentViewHolder host, int position) {
        Comment comment = commentList.get(position - 1);
        host.commentDescription.setText(comment.getDescription());
        host.commentTime.setText(Utils.timeTransformer(comment.getTime()));
        host.commentUser.setText(comment.getCommenter());
    }
